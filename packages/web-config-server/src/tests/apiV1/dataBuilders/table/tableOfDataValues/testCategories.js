...
export const testCategories = () => {
  describe('row categories', () => {
    ...
    it('rows with same title in the same categories', () =>
      assertTableResults(
        {
    ...
    it('rows with same title in different categories', () =>
      assertTableResults(
        {
          rows: [
  ...
  describe('column categories', () => {
    ...
    it('columns with same title in the same categories', () =>
      assertTableResults(
        {
          rows: ['Count'],
    ...
    it('columns with same title in different categories', () =>
      assertTableResults(
        {
          rows: ['Count'],
          columns: [
  ...
  describe('row and column categories', () => {
    it('1 category x 1 row, 1 category x 1 column', () =>
      assertTableResults(
        {
          rows: [{ category: 'Risk Factors', rows: ['Smokers'] }],
